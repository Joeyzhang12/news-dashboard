...
def get_proxy():
    if not PROXY_USER: return None
    try:
        r = requests.get("http://api.xiongmaodaili.com/api/getip?num=1&type=2", 
...
def main():
    ...
    news = []
    sources = ["ProPublica", "ZeroHedge", "The Intercept", "The Grayzone", "CoinDesk", "观察者网", "BBC", "The Atlantic"]
    cats = ["investigation", "finance", "investigation", "investigation", "crypto", "geopolitics", "business", "politics"]
